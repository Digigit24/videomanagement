...
import { recycleBinService } from '@/services/api.service';
import { Workspace, User } from '@/types';
import { Button } from '@/components/ui/button';
import { RefreshCw, Trash2, User as UserIcon, Building2 } from 'lucide-react';
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Items are permanently deleted after 5 days. Only admins can restore them.
        </p>
      </div>
