...
export default function DeleteUserModal({ userId, userName, onClose, onDeleted }: DeleteUserModalProps) {
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-sm mx-4 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Are you sure you want to delete <strong>{userName}</strong>? This will remove their access immediately.
          </p>
          <div className="space-y-1">
            <label className="text-xs font-medium text-gray-700 dark:text-gray-400">Confirm Admin Password</label>
            <Input
              type="password"
              value={password}
