...
export default function TimestampPanel({ comments, onSeekTo, onMarkerStatusUpdate, currentTime }: TimestampPanelProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto max-h-[calc(56.25vw*0.66-48px)] lg:max-h-[400px]">
