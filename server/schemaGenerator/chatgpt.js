 ...
 * @param {string} model - Model name (default: llama-3.3-70b-versatile for accuracy)
 * @param {number} maxTokens - Max output tokens
 * @param {number} temperature - Creativity (lower = more deterministic)
...
module.exports = { sendChatGPTRequest };
